...
public class CityCountry {
    ...
    public CityCountry(Integer id, String name, String district, Integer population, String countryCode, String alternativeCountryCode, String countryName, Continent continent, String countryRegion, BigDecimal countrySurfaceArea, Integer countryPopulation, Set<Language> languages) {
        this.id = id;
        this.name = name;
